...
namespace Tyuiu.SmirnovMN.Sprint2.Task5.V2.Test
{
    [TestClass]
    public class DataServiceTest
    {
        ...
        public void ValidFindMonthName()
        {
            ...
            Assert.AreEqual("Зима", ds.FindMonthSeason(3));
            Assert.AreEqual("Весна", ds.FindMonthSeason(4));
            Assert.AreEqual("Весна", ds.FindMonthSeason(5));
            Assert.AreEqual("Весна", ds.FindMonthSeason(6));
            Assert.AreEqual("Лето", ds.FindMonthSeason(7));
            Assert.AreEqual("Лето", ds.FindMonthSeason(8));
            Assert.AreEqual("Лето", ds.FindMonthSeason(9));
            Assert.AreEqual("Лето", ds.FindMonthSeason(10));
            Assert.AreEqual("Лето", ds.FindMonthSeason(11));
